...
SCOPES = "chat:read chat:edit moderator:read:chatters moderator:read:followers moderator:manage:banned_users channel:manage:broadcast channel:read:subscriptions channel:read:redemptions clips:edit user:read:follows channel:read:hype_train  channel:manage:raids"
